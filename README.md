...
|---|---:|---:|---:|---:|---:|
| ANTIBACTERIAL *(incl. subclasses)* | 1117 | 1059 | 26 | 32 | 285 |
...
Identity: **2669** records (91%) are grounded in a ChEBI term; **266** keep a minted `antibioticmech:` CURIE because no ChEBI entry with a structure covers them.
...
covering all 2,935 records. Its coordinates and nearest neighbors use only the
