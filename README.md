...
|---|---:|---:|---:|---:|---:|
| ANTIBACTERIAL *(incl. subclasses)* | 1110 | 1059 | 19 | 32 | 285 |
...
Identity: **2669** records (91%) are grounded in a ChEBI term; **259** keep a minted `antibioticmech:` CURIE because no ChEBI entry with a structure covers them.
...
covering all 2,928 records. Its coordinates and nearest neighbors use only the
