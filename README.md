...
|---|---:|---:|---:|---:|---:|
| ANTIBACTERIAL *(incl. subclasses)* | 1118 | 1059 | 27 | 32 | 285 |
...
Identity: **2669** records (91%) are grounded in a ChEBI term; **267** keep a minted `antibioticmech:` CURIE because no ChEBI entry with a structure covers them.
...
covering all 2,936 records. Its coordinates and nearest neighbors use only the
