...
|---|---:|---:|---:|---:|---:|
| ANTIBACTERIAL *(incl. subclasses)* | 1116 | 1059 | 25 | 32 | 285 |
...
Identity: **2669** records (91%) are grounded in a ChEBI term; **265** keep a minted `antibioticmech:` CURIE because no ChEBI entry with a structure covers them.
...
covering all 2,934 records. Its coordinates and nearest neighbors use only the
