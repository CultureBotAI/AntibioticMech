...
|---|---:|---:|---:|---:|---:|
| ANTIBACTERIAL *(incl. subclasses)* | 1113 | 1059 | 22 | 32 | 285 |
...
Identity: **2669** records (91%) are grounded in a ChEBI term; **262** keep a minted `antibioticmech:` CURIE because no ChEBI entry with a structure covers them.
...
covering all 2,931 records. Its coordinates and nearest neighbors use only the
