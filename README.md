...
|---|---:|---:|---:|---:|---:|
| ANTIBACTERIAL *(incl. subclasses)* | 1119 | 1059 | 28 | 32 | 285 |
...
Identity: **2669** records (91%) are grounded in a ChEBI term; **268** keep a minted `antibioticmech:` CURIE because no ChEBI entry with a structure covers them.
...
covering all 2,937 records. Its coordinates and nearest neighbors use only the
