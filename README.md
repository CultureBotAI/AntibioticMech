...
|---|---:|---:|---:|---:|---:|
| ANTIBACTERIAL *(incl. subclasses)* | 1120 | 1059 | 29 | 32 | 285 |
...
Identity: **2669** records (91%) are grounded in a ChEBI term; **269** keep a minted `antibioticmech:` CURIE because no ChEBI entry with a structure covers them.
...
covering all 2,938 records. Its coordinates and nearest neighbors use only the
