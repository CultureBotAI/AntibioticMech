...
|---|---:|---:|---:|---:|---:|
| ANTIBACTERIAL *(incl. subclasses)* | 1114 | 1059 | 23 | 32 | 285 |
...
Identity: **2669** records (91%) are grounded in a ChEBI term; **263** keep a minted `antibioticmech:` CURIE because no ChEBI entry with a structure covers them.
...
covering all 2,932 records. Its coordinates and nearest neighbors use only the
