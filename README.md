...
|---|---:|---:|---:|---:|---:|
| ANTIBACTERIAL *(incl. subclasses)* | 1115 | 1059 | 24 | 32 | 285 |
...
Identity: **2669** records (91%) are grounded in a ChEBI term; **264** keep a minted `antibioticmech:` CURIE because no ChEBI entry with a structure covers them.
...
covering all 2,933 records. Its coordinates and nearest neighbors use only the
