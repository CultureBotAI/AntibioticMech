#!/usr/bin/env python3
"""Strict LinkML validation harness for AntibioticMech instance records.
...
AntibioticMech has a single root class (AntibioticRecord); no class routing required.
"""
...
def main() -> int:
    ...
    parser.add_argument("paths", nargs="*", type=Path,
                        help="Files or directories. Defaults to data/antibiotics/.")
